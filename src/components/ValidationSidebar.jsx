  ...
  return (
    <>
      ...
      <Sheet open={expanded} onOpenChange={handleSheetOpenChange}>
        {/* Fundo só escurecido, sem desfoque (o DESIGN.md recusa blur de fundo). backdrop-blur-none explícito: o overlay
            base do Sheet traz backdrop-blur-xs, que voltaria se a classe só fosse removida. */}
        <SheetContent
